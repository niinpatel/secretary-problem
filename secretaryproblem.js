/**
 * Problem: You want to hire a secretary out of N candidates.
 * For each candidate you interview, you have to make a decision whether to accept or reject him/her.
 * You cannot reverse a decision once it is made. Assume each candidates can be ranked against each other.
 * If you are interviewing them in a random order,
 * How do you select a candidate in a way that there is a maximum change of finding the best
...
console.log(selectSecretary(candidatesList, 20));